...
{
    public class CriarProdutoCommand : IRequest<Guid>// o Irequest é uma interface doo MediaTR - indica que o command será processado por um handler. retorna tipo T
    {
